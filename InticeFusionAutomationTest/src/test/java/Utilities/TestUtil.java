...
//	public static boolean isExecutable(String sheetName)
//	{
//		for(int rowNum = 2; rowNum<=excel.getRowCount(sheetName); rowNum++)
//		{
//			if(excel.getCellData(sheetName, "tcid", rowNum).equals(sheetName))
//			{
//				return true;
//			}
//			else
...
//	}
	...
	public static void get_Segment_Details()
	{
		String segment = driver.findElement(By.xpath(OR.getProperty("segmentyear"))).getText();
